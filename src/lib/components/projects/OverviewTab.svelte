			...
			<Card.Root class="shadow-sm">
				<Card.Header class="pb-4">
					<div class="flex items-center gap-2">
						...
						<h3 class="text-lg font-semibold text-slate-800">Implementing Agency</h3>
					</div>
				</Card.Header>
				<Card.Content class="pt-0">
					<div class="space-y-4">
						...
						{#if project.project_manager_team?.project_manager}
							<div>
								<div class="mb-1 text-xs font-semibold tracking-wider text-slate-400 uppercase">
									Project Manager
								</div>
								<div class="text-sm font-medium text-slate-700">
									{project.project_manager_team.project_manager}
								</div>
							</div>
						{/if}
						{#if project.project_manager_team?.technical_lead}
							<div>
								<div class="mb-1 text-xs font-semibold tracking-wider text-slate-400 uppercase">
									Technical Lead
								</div>
								<div class="text-sm font-medium text-slate-700">
									{project.project_manager_team.technical_lead}
								</div>
							</div>
						{/if}
					</div>
			...
			<Card.Root class="shadow-sm">
				<Card.Header class="pb-4">
					<div class="flex items-center gap-2">
						...
						<h3 class="text-lg font-semibold text-slate-800">Employment Generated</h3>
					</div>
				</Card.Header>
				<Card.Content class="pt-0">
					<div class="grid grid-cols-2 gap-4">
						...
						<div class="rounded-lg border border-pink-100 bg-pink-50 p-4 text-center">
